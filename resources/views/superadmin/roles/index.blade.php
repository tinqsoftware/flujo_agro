...
@section('header-actions')
    <a href="{{ route('superadmin.roles.create') }}" class="btn btn-light">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('superadmin.roles.edit', $rol) }}" 
...
function confirmarEliminacion(rolId, nombreRol) {
    ...
    document.getElementById('formEliminar').action = `/superadmin/roles/${rolId}`;
...
function toggleEstado(rolId, estado) {
    fetch(`/superadmin/roles/${rolId}/toggle-estado`, {
        method: 'PATCH',
        headers: {
